...
export default function FornecedorFormPage() {
      ...
      obterPessoa(id)
        .then((pessoa) => {
          if (pessoa) {
            ...
            toast({ title: "Fornecedor nÍo encontrado", variant: "destructive" });
            navigate("/pessoas/fornecedores");
          }
        })
        .catch((error) => {
          console.error("Erro ao carregar fornecedor:", error);
          toast({ title: "Erro ao carregar dados do fornecedor", variant: "destructive" });
          navigate("/pessoas/fornecedores");
        })
        .finally(() => {
          setLoading(false);
  ...
  async function handleSubmit(data: PessoaInput) {
    try {
      ...
      toast({
        title: message || "Erro ao salvar fornecedor. Verifique os dados e tente novamente.",
        variant: "destructive",
      });
    }
  }

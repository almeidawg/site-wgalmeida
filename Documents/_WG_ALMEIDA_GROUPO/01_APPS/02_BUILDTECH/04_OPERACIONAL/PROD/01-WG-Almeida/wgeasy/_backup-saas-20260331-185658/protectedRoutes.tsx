...
export const protectedRoutes = (
  <>
    ...
    {/* PROPOSTAS - VersÍo V3 Nova Estrutura (Cliente + Analise + Nucleos) */}
    ...
    {/* PROPOSTAS V1 - VersÍo antiga (mantida para compatibilidade) */}
    ...
    {/* ICCRI - Motor de PrecificaçÍo (MASTER only) */}

            ...
            >
              ...
              <div className="flex flex-col md:flex-row items-center justify-center gap-6 mb-8">
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-xl font-light text-gray-700">Google</span>
                </div>
                ...
                {reviews.map((review) => (
                  <article key={review.id} className="rounded-2xl border border-gray-100 bg-wg-gray-light p-4">
                    <div className="flex items-center gap-3 mb-2">
                      <div className="w-8 h-8 rounded-full bg-wg-orange/10 text-wg-orange flex items-center justify-center text-sm font-light">
                        {review.avatar}
                      </div>
                      <div>
                        <p className="text-sm font-light text-wg-black">{review.name}</p>
        ...
        <div className="container-custom">
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-6">
            {partners.map((partner, index) => (
              ...
              >
                <span className="text-wg-gray font-light text-center group-hover:text-wg-orange transition-colors duration-300">
                  {partner.name}
                </span>
              </motion.div>
            ))}

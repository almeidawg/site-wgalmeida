      ...
      <section className="relative h-[60vh] flex items-center justify-center overflow-hidden hero-under-header">
        ...
        >
          <ResponsiveWebpImage
            ...
            src="/images/imagens/MARCENARIA-VILAMARIANA (1).webp" 
            width="1920"
            height="1080"
          />
        ...
        <div className="relative z-10 container-custom text-center text-white px-4">
          ...
          <motion.h1
            ...
            className="text-5xl md:text-7xl font-inter font-bold mb-6 tracking-tighter"
          >
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            {features.map((item, index) => (
              ...
              >
                ...
                <h3 className="text-xl font-bold text-wg-black mb-3">{item.title}</h3>
        ...
        <div className="container-custom">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            >
              ...
              <img 
                src="/images/imagens/MARCENARIA-ACLIMACAO.webp" 

...
const JARDINS_HERO_IMAGE = getPublicPageImageSrc('reformaApartamentoJardins', withBasePath('/images/banners/PROJETOS.webp'));
    ...
    <>
      ...
      <section className="wg-page-hero hero-under-header bg-wg-black">
        <div
          ...
          style={{ backgroundImage: `url(${JARDINS_HERO_IMAGE})` }}
        />

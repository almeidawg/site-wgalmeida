          ...
          >
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              <Link to="/projetos">
                <Button
                  variant="outline"
                  className="border-white text-white hover:bg-white hover:text-wg-black transition-all rounded-2xl px-6 py-3"
                >
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {tiposReforma.map((reforma, index) => (
              ...
              >
                ...
                <p className="text-wg-gray mb-4 font-light">{reforma.descricao}</p>
            ...
            {etapas.map((etapa, index) => (
              ...
              >
                ...
                <div className="flex-1">
                  ...
                  <p className="text-wg-gray mb-2 font-light">{etapa.descricao}</p>
      ...
      <section className="section-padding bg-white">
        <div className="container-custom">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-5xl mx-auto">
            {faixasInvestimento.map((faixa, index) => (
              ...
              >
                ...
                <p className="text-2xl text-wg-orange mb-6">{faixa.valor}</p>
          ...
          <p className="text-center text-sm text-wg-gray mt-8">
            *Valores de referência para São Paulo em 2026. Orçamento final depende de metragem,
            escopo e acabamentos selecionados.
          </p>
        </div>
      </section>
          ...
          >
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              <a
                ...
                className="inline-flex items-center gap-2 px-6 py-3 border-2 border-white text-white rounded-2xl font-medium hover:bg-white hover:text-wg-black transition-all"
              >

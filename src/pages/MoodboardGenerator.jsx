        ...
        {!showPreview ? (
          <>
            ...
            <div className="bg-white rounded-lg shadow-lg p-8 space-y-8">
              {/* Client Name */}
              <div>
                <label className="block text-sm text-gray-700 mb-2">Nome do Cliente *</label>
                <input
                  type="text"
                  value={clientName}
              ...
              {/* Style Selection */}
              <div>
                <label className="block text-sm text-gray-700 mb-2">Estilo *</label>
                <select
                  value={selectedStyle}
              ...
              {/* Color Palette */}
              <div>
                <label className="block text-sm text-gray-700 mb-2">Paleta de Cores</label>
              ...
              {/* Environments */}
              <div>
                <label className="block text-sm text-gray-700 mb-2">Ambientes</label>
              ...
              {/* Materials */}
              <div>
                <label className="block text-sm text-gray-700 mb-2">Materiais e Paletas</label>
                <div className="grid grid-cols-2 md:grid-cols-3 gap-3">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                  <label className="block text-sm text-gray-700 mb-2">Tamanho da Página</label>
                  <select
                    value={pageSize}
                ...
                <div>
                  <label className="block text-sm text-gray-700 mb-2">Orientação</label>
                  <select
                    value={orientation}
              ...
              <button
                ...
                className="w-full py-4 bg-wg-orange text-white rounded-lg text-lg hover:bg-orange-600 disabled:bg-gray-400 disabled:cursor-not-allowed transition-colors"
              >
          ...
          <div>
            ...
            <div className="flex justify-between items-center mb-6">
              ...
              <button
                ...
                className="flex items-center gap-2 px-6 py-3 bg-wg-orange text-white rounded-lg hover:bg-orange-600 transition-colors"
              >

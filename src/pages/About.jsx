          ...
          >
            {stats.map((stat, index) => (
              ...
              >
                ...
                <p className="text-wg-gray text-sm font-medium">{stat.label}</p>
              </motion.div>
            ))}
          </motion.div>
        </div>
        ...
        <div className="container-custom">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center mb-20">
            <motion.div
              ...
              transition={{ duration: 0.6 }}
            >
              <h2 className="text-3xl md:text-4xl font-oswald font-bold text-wg-black mb-6">
                {t('aboutPage.story.title')}
              </h2>
              <p className="text-lg text-wg-gray font-roboto leading-relaxed mb-4">
                {t('aboutPage.story.paragraphs.0')}
              </p>
              <p className="text-lg text-wg-gray font-roboto leading-relaxed mb-4">
                {t('aboutPage.story.paragraphs.1')}
              </p>
              <p className="text-lg text-wg-gray font-roboto leading-relaxed">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            {values.map((value, index) => (
              ...
              >
                ...
                <div className={`absolute top-0 left-0 right-0 h-1 bg-${value.color} transform origin-left scale-x-0 group-hover:scale-x-100 transition-transform duration-500`} />

                {/* Ícone com background */}
                <div className={`inline-flex items-center justify-center w-14 h-14 rounded-xl bg-${value.color}/10 mb-5 group-hover:scale-110 transition-transform duration-300`}>
                ...
                {/* Elemento decorativo */}
                <div className={`absolute -bottom-4 -right-4 w-24 h-24 bg-${value.color}/5 rounded-full group-hover:scale-150 transition-transform duration-700`} />
              </motion.div>
            ))}
          </div>
        </div>
            ...
            >
              <div className="relative">
                ...
                <div className="relative rounded-2xl overflow-hidden">
                  <img
                    src="/images/imagens/fotoCEO.webp"
                  ...
                  <div className="absolute bottom-0 left-0 right-0 p-8">
                    ...
                    >
                      <span className="text-wg-orange text-sm font-medium tracking-[0.2em] uppercase mb-2 block">
              ...
              <div className="space-y-6">
                <p className="text-lg md:text-xl text-white/90 font-light leading-relaxed">
                  <Trans i18nKey="aboutPage.ceo.paragraphs.0">
                    Antes de ser grupo, sistema ou metodo, existia um desafio comum: <span className="text-wg-orange font-medium">decisoes sem dados claros</span>.
                  </Trans>
                </p>

                <p className="text-lg text-white/80 font-light leading-relaxed">
                  <Trans i18nKey="aboutPage.ceo.paragraphs.1">
                    A resposta nunca foi improvisada. <span className="text-white font-medium">Foi estrutura.</span>
                  </Trans>
                </p>
                ...
                <p className="text-base text-white/70 leading-relaxed">
                  <Trans i18nKey="aboutPage.ceo.paragraphs.3">
                    Nesse contexto surgiu o <span className="text-wg-orange font-medium">WG Easy</span>.
                  </Trans>
                </p>
                ...
                <div className="pt-6 border-t border-white/10">
                  <p className="text-lg text-white/90 font-light leading-relaxed">
                    <Trans i18nKey="aboutPage.ceo.paragraphs.4">
                      O Grupo WG Almeida se consolida como uma estrutura que une <span className="text-wg-orange font-medium">visao executiva</span>.
                    </Trans>
                  </p>
                </div>
                ...
                >
                  ...
                  <span className="text-wg-orange font-medium tracking-wide">{t('aboutPage.ceo.signature')}</span>
                </motion.div>
              </div>
            </motion.div>
          </div>

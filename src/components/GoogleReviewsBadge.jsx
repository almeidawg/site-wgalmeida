...
const GoogleReviewsBadge = () => {
  ...
  const structuredData = {
    ...
    priceRange: '$$$',
    image: 'https://wgalmeida.com.br/images/logo.png',
  ...
  return (
    <>
      ...
      <section className="py-12 bg-wg-gray-light">
        <div className="container-custom">
          ...
          >
            <div className="inline-flex items-center gap-3 bg-white rounded-xl px-5 py-3 shadow-md border border-gray-100">
              ...
              <div className="flex items-center gap-1">
                {[1, 2, 3, 4, 5].map((star) => (
                  <Star key={star} className="h-4 w-4 text-wg-orange fill-wg-orange" />
                ))}
              </div>
              <span className="text-lg font-bold text-wg-black">{averageRating.toFixed(1)}</span>

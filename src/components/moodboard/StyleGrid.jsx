...
// Estilos de design de interiores
const INTERIOR_STYLES = [
  {
    id: 'moderno',
    name: 'Moderno',
    image: 'https://images.unsplash.com/photo-1600210492486-724fe5c67fb0?w=800',
    description: 'Linhas limpas, minimalismo e materiais contemporâneos',
    tags: ['clean', 'minimalista', 'contemporâneo'],
  ...
  },
  {
    ...
    description: 'Elegância atemporal com detalhes ornamentais',
    tags: ['elegante', 'tradicional', 'sofisticado'],
  ...
  },
  {
    ...
    description: 'Tijolos expostos, metal e madeira bruta',
    tags: ['urbano', 'rústico', 'loft'],
    category: 'contemporaneo',
  },
  {
    id: 'escandinavo',
    ...
    description: 'Simplicidade funcional com tons neutros e madeira clara',
    tags: ['hygge', 'funcional', 'aconchegante'],
    category: 'contemporaneo',
  },
  {
    id: 'rustico',
    ...
    description: 'Materiais naturais e texturas orgânicas',
    tags: ['natural', 'acolhedor', 'campo'],
    category: 'tradicional',
  },
  {
    id: 'minimalista',
    ...
    description: 'Menos é mais - espaços limpos e funcionais',
    tags: ['simples', 'clean', 'zen'],
    category: 'contemporaneo',
  },
  {
    id: 'bohemio',
    ...
    description: 'Cores vibrantes, texturas e elementos artesanais',
    tags: ['colorido', 'eclético', 'artístico'],
    category: 'eclético',
  },
  {
    id: 'luxo',
    ...
    description: 'Materiais nobres e acabamentos premium',
    tags: ['premium', 'sofisticado', 'exclusivo'],
    category: 'contemporaneo',
  },
  {
    id: 'tropical',
    ...
    description: 'Natureza exuberante com plantas e cores vibrantes',
    tags: ['verde', 'natureza', 'vibrante'],
    category: 'eclético',
  },
  {
    id: 'japones',
    ...
    description: 'Harmonia, natureza e simplicidade zen',
    tags: ['zen', 'harmonia', 'natural'],
    category: 'tradicional',
  },
  {
    id: 'artdeco',
    ...
    description: 'Geometria, glamour e acabamentos dourados',
    tags: ['glamour', 'geométrico', 'vintage'],
    category: 'tradicional',
  },
  {
    id: 'mediterraneo',
    ...
    description: 'Tons terrosos, arcos e texturas naturais',
    tags: ['terroso', 'acolhedor', 'ensolarado'],
    category: 'tradicional',
  },
];

        ...
        <div className="group relative rounded-2xl overflow-hidden transition-all duration-500 hover:shadow-2xl hover:-translate-y-2 bg-white border border-gray-100">
          ...
          <div className="p-5 relative">
            ...
            <div className="flex items-baseline gap-2 mb-4">
              <span className={`font-bold ${cardStyles.accent} text-xl`}>{displayPrice}</span>
              {hasSale && (
            ...
            <Button
              ...
              className={`w-full ${cardStyles.button} text-white transition-all duration-300 group-hover:shadow-lg`}
            >

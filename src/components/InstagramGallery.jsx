            ...
            >
              ...
              <div className="relative aspect-square bg-gray-100">
                {!imageErrors[selectedPost.id] ? (
                  ...
                  <div className="w-full h-full flex flex-col items-center justify-center bg-gradient-to-br from-purple-500 via-pink-500 to-orange-500 text-white">
                    ...
                    <span className="text-lg font-light">{t('instagramGallery.openOnInstagram')}</span>
                  </div>
                )}
              </div>
              ...
              <div className="p-4 bg-white border-t flex items-center justify-between">
                ...
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="inline-flex items-center gap-2 px-4 py-2 bg-gradient-to-r from-purple-500 via-pink-500 to-orange-500 text-white rounded-lg font-light hover:opacity-90 transition-opacity"
                >

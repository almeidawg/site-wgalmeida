// SanfonaHero v4 — WG Almeida — 25/03/2026
...
const COMPANIES = [
  {
    ...
    img: 'https://plus.unsplash.com/premium_photo-1683121877675-37d9a4f5bada?auto=format&fit=crop&w=1280&q=90',
    imgPos: 'center center',
  },
  {
    id: 'engenharia', index: '02', name: 'Engenharia',
    color: '#2B4580', path: '/home',
    ...
    img: 'https://images.unsplash.com/photo-1517581177682-a085bb7ffb15?auto=format&fit=crop&w=1280&q=90',
    imgPos: 'center 40%',
  },
  {
    id: 'marcenaria', index: '03', name: 'Marcenaria',
    color: '#8B5E3C', path: '/home',
    ...
    cta: 'Ver marcenaria',
    img: 'https://images.unsplash.com/photo-1632583824020-937ae9564495?auto=format&fit=crop&w=1280&q=90',
    imgPos: 'center center',
  },
  {
    ...
    img: 'https://plus.unsplash.com/premium_photo-1661877737564-3dfd7282efcb?auto=format&fit=crop&w=1280&q=90',
    imgPos: 'center center',
  },
  {
    ...
    img: 'https://images.unsplash.com/photo-1617021483925-a331d536133d?auto=format&fit=crop&w=1280&q=90',
    imgPos: 'center center',
  },
  {
    ...
    img: 'https://images.unsplash.com/photo-1553361371-9b22f78e8b1d?auto=format&fit=crop&w=1280&q=90',
    imgPos: 'center center',
  },
];
...
export default function SanfonaHero() {
  ...
  const onLeave = ()  => { if (desktop) setActive(null); };
  ...
  const onKey = (e, i, path) => {
    ...
    if (e.key === 'Escape') { setActive(null); setTapped(false); }
  };
      ...
      {COMPANIES.map((c, i) => {
        ...
        return (
          <article
            ...
            style={{
              position: 'relative',
              flex: active === null ? 1 : (isActive ? fActive : fInactive),

...
Registrar, dentro do projeto do site WG Almeida, qual e a origem canonica para:

- marca
- narrativa institucional
- posicionamento
- missao, visao, valores e proposito
- marketing e SEO
- materiais de apoio para Liz e automacoes

Este documento nao substitui a pasta central de marketing.
Ele existe para apontar para a origem correta e evitar que qualquer IA reinvente conteudo institucional diretamente no codigo.
...
- antes de alterar textos institucionais, comerciais ou de marca do site, consultar esta pasta;
- se uma definicao canonica mudar, refletir a mudanca la para que site, Liz e automacoes usem a mesma base.

## Estrutura relevante confirmada
...
### 1. Missao, visao, valores, proposito e filosofia
...
- pagina A Marca
- manifestos
- textos de apresentacao em automacoes

### 2. Posicionamento comercial e proposta de valor
...
- foco em atender clientes que compram planejados e precisam da execucao completa da obra;
- proposta de atendimento centralizado e integrado;
- diferencial em qualidade, prazo e acabamento;
- importancia de equipe especializada, tecnologia e controle de obra;
- presenca digital, portfolio e depoimentos como pilares de marketing.

Uso:

- landings comerciais
- ObraEasy / EasyRealState / parcerias
- discursos de vendas
- automacoes de qualificaçao e atendimento

### 3. Storytelling humano e narrativa do fundador
...
- origem no Capão Redondo e jornada de trabalho desde muito cedo;
- passagem por marketing, SEO e vendas;
- entrada em planejados e virada de carreira;
- superacao de dificuldades financeiras;
- transformacao da historia pessoal em liderança comercial e visao turn key.
...
- videos
- bio expandida
- materiais de relacionamento e confiança
...
- perfil pensado para arquitetura, engenharia e marcenaria;
- estrategia com antes/depois, educativo, bastidores, institucional e prova social;
- calendario, legendas e roteiros ja prontos;
- recomendacoes de bio, palavras-chave e frequencia de postagem.

Uso:

- blog-to-social
- alinhamento entre site e Instagram
- automacoes de conteudo
- briefs de campanha

### 5. Liz e identidade visual da assistente
...
- referencias visuais da Liz
- materiais institucionais da assistente
- futuras telas, landing da Liz e campanhas

## Regras operacionais para qualquer IA

1. Nao criar nova missao, visao, valores ou filosofia direto no codigo sem consultar a pasta central.
2. Nao usar um texto isolado do site como fonte canonica se existir documento institucional mais forte na pasta de marketing.
3. Quando houver conflito, priorizar:
   1. documentos institucionais e de marca
   2. business plan
   3. storytelling e materiais comerciais
   4. codigo atual do site
4. Quando um novo texto for aprovado como canonico, registrar a mudanca na pasta central ou apontar a divergencia.

## Diretrizes ja alinhadas com o site

### Tipografia e linguagem

Diretriz atual aprovada:
...
## Proximo nivel de organizacao

Depois da leitura consolidada desta origem, o ideal e gerar um arquivo canonico operacional com:
...
- posicionamento
- elevator pitch
- proposta de valor por unidade de negocio
- links e perfis oficiais

Sugestao de nome:

- `00_CORE\05_MARCA_E_MARKETING\_I\CANONICO-MARCA-WG-ALMEIDA.md`

## Conclusao

Para o site WG Almeida, a pasta `_I` em marketing ja deve ser tratada como origem institucional obrigatoria.

Este projeto nao deve mais depender apenas de textos espalhados no front para definir identidade.
